...
def main():
    ...
    if app_name == 'bc-3' and cluster_option == 'i':
        alphas = [float(sys.argv[3]), float(sys.argv[4])]
    else:
    ...
    if app_name == 'bc-3' and cluster_option == 'i':
        tch_options = [sys.argv[8], sys.argv[9]]
    else:
    ...
    if app_name == 'bc-3' and cluster_option == 'i':
        model_save_path = os.path.join(model_dir, cluster_option, f"{app_name}.student.{option}.{alphas[0]*100}.{alphas[1]*100}.pth")
        tsv_path = os.path.join(results_dir, cluster_option, f"{app_name}.student.{option}.{alphas[0]*100}.{alphas[1]*100}.tsv")
    else:
        model_save_path = os.path.join(model_dir, cluster_option, f"{app_name}.student.{option}.{alphas[0]*100}.{alphas[1]*100}.{alphas[2]*100}.{alphas[3]*100}.pth")
        tsv_path = os.path.join(results_dir, cluster_option, f"{app_name}.student.{option}.{alphas[0]*100}.{alphas[1]*100}.{alphas[2]*100}.{alphas[3]*100}.tsv")
